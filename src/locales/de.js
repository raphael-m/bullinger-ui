export default {
  ...
  editor: {
    ...
    sender: {
      ...
      lastname: "Nachname",
      lastname_tip:
        "Nachname ohne Klammern; falls mehrere Absender angegeben sind: Nur Nachname des ersten Absenders",
      firstname: "Vorname",
      firstname_tip:
        "Vorname(n) ohne Klammern; falls mehrere Absender angegeben sind: Nur Vorname(n) des ersten Absenders",
      location: "Ort",
    ...
    receiver: {
      ...
      lastname: "Nachname",
      lastname_tip:
        "Nachname ohne Klammern; falls mehrere Empfänger angegeben sind: Nur Nachname des ersten Empfängers",
      firstname: "Vorname",
      firstname_tip:
        "Vorname(n) ohne Klammern; falls mehrere Empfänger angegeben sind: Nur Vorname(n) des ersten Empfängers",
      location: "Ort",
      location_tip: "Ortsname ohne Klammern",
      verified: "Verifiziert?",
      not_verified: "Nicht verifiziert",
    ...
    autograph: {
      ...
      location: "Standort",
      location_tip:
        "Standort ohne Komma<br>Die meisten Briefe stehen entweder im Staatsarchiv Zürich oder der Zentralbibliothek Zürich (ZZB). Diese Standorte bitte jeweils wie folgt eintragen: Zürich StA oder Zürich ZB",
      signature: "Signatur",
      signature_tip:
    ...
    contents: {
      ...
      language: "Sprache",
      language_tip:
        "Sprache gemäss Eintrag auf der Karteikarte bzw. gemäss Sprache des ersten Satzes. Bitte geben Sie die Sprache in folgenden Schreibweisen an: Latein, Deutsch, Griechisch etc.",
      printed: "Gedruckt",
      printed_tip:
        'Literaturangabe gemäss Karteikarte. Können Sie den Eintrag nicht entziffern, tragen Sie dies bitte in den Anmerkungen zur Karteikarte ein und setzen den Status auf "Unklar"',
